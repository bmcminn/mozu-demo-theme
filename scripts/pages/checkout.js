  ...
  function ($, _, Hypr, Backbone, CheckoutModels, messageViewFactory, CartMonitor, HyprLiveContext, EditableView, preserveElements) {
    ...
    var CheckoutStepView = EditableView.extend({
      ...
      resize: _.debounce(function () {
        this.$('.mz-panel-wrap').animate({
          'height': this.$('.mz-inner-panel').outerHeight()
        });
      }, 200)
    });
    ...
    /**
     * [ShippingAddressView description]
     * @type {[type]}
     */
    ...
    /**
     * [updateShippingMethod description]
     * @param  {[type]} e) {                   this.model.updateShippingMethod(this.$('[data-mz-shipping-method]:checked').val());      }    } [description]
    ...
    /**
     * [visaCheckoutSettings description]
     * @type {[type]}
     */
    ...
    /**
     * [handleLoadingChange description]
     * @param  {Boolean} isLoading)         {                                                                                       } [description]
     * @param  {[type]}  initialize:        function      ()      {             var me [description]
     * @param  {[type]}  onEnterCouponCode: function      (model, code) {           if (code         && !this.codeEntered) {                         this.codeEntered [description]
     * @return {[type]}                     [description]
     */
