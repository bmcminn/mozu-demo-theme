...
(function (root, factory) {
  ...
  // Set up CLog appropriately for the environment. Start with AMD.
  if (typeof define === 'function' && define.amd) {
    define(['clog'], function, exports) {
      // Export global even in AMD case in case this script is loaded with
      // others that may still expect a global CLog.
      root.CLog = factory(root, exports);
    });
  ...
  // Finally, as a browser global.
    ...
    root.CLog = factory(root, {});

  }

}(this, function (root, CLog) {
