...
! function (e, t, n) {
  ...
  function l(e, n, r, o) {
    ...
    return i = a("style"), i.type = "text/css", i.id = "s" + f, (m.fake ? m : d).appendChild(i), m.appendChild(d), i.styleSheet ? i.styleSheet.cssText = e : i.appendChild(t.createTextNode(e)), d.id = f, m.fake && (m.style.background = "", m.style.overflow = "hidden", c = b.style.overflow, b.style.overflow = "hidden", b.appendChild(m)), l = n(d, e), m.fake ? (m.parentNode.removeChild(m), b.style.overflow = c, b.offsetHeight) : d.parentNode.removeChild(d), !!l
  }
  ...
  function h(e, t, o, i) {
    ...
    for (var f, d, m, h, v, g = ["modernizr", "tspan"]; !M.style;) f = !0, M.modElem = a(g.shift()), M.style = M.modElem.style;
    for (m = e.length, d = 0; m > d; d++)
      if (h = e[d], v = M.style[h], u(h, "-") && (h = c(h)), M.style[h] !== n) {
        if (i || r(o, "undefined")) return s(), "pfx" == t ? h : !0;
        try {
          M.style[h] = o
        }
        catch (y) {}
        if (M.style[h] != v) return s(), "pfx" == t ? h : !0
      }
    return s(), !1
  }
  ...
  E._domPrefixes = _, Modernizr.addTest("history", function () {
  ...
  E.mq = z;
  var k = (E.testStyles = l, E._config.usePrefixes ? w.split(" ") : []);
  E._cssomPrefixes = k;
  var A = {
    elem: a("modernizr")
  };
  ...
  E.testAllProps = v, E.testAllProps = g, Modernizr.addTest("csstransitions", g("transition", "all", !0)), o(), i(y), delete E.addTest, delete E.addAsyncTest;
