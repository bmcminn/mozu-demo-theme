...
//     , themeSettings = require.mozuData('themeSettings')
...
//     , regex = {
//         vimeoID:    /\/?(\d{6,})/i
//       , youtubeID:  /(?:^[^htp<]|youtu\.be\/|embed\/|v=)([\d\w_-]{6,})/i
//       , listID:     /(?:list=)([\d\w_-]{6,})/i
//       }
//     ;

//   // get the product images together
//   images = _.map(product.content.productImages, function(img) {
//     return {
...
//   // get the product videos property from the product model
//   videos = _.where(product.properties, {attributeFQN: "tenant~videos"});


//   //
//   // generate slideshow markup
//   //

//   slideshow = [
//     '<div class="mz-product-slideshow">'
//   ,   '<ul data-mz-role="product-slideshow">'
//   ].join('');
...
//   // generate video containers (if available)
//   if (!_.isEmpty(videos)) {
//     videos = videos[0].values[0].stringValue.split('\n');

//     _.each(videos, function(video) {

//       // check if it's Vimeo
//       if (video.match(regex.vimeoID)) {
//         video.id = regex.vimeoID[1];
//       }
...
//         if (video.match(regex.youtubeID)) {
//           video.id = regex.youtubeID[1];
//         }

//         // check if we have a playlist
//         if (video.match(regex.listID)) {
//           video.list = regex.listID[1]
//         }
//       }
