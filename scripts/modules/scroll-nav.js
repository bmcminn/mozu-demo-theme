define([
    ...
    'underscore',
    'modules/api',
    'shim!vendor/bootstrap/js/affix[jquery=jQuery]',
    'shim!vendor/bootstrap/js/scrollspy[jquery=jQuery]'
  ],
  function ($, Hypr, _, api) {
      ...
      $(document).ready(function () {
        $('[data-mz-scrollnav]').each(function () {
          ...
          $this.on('click', 'a', function (e) {
            e.preventDefault();
            $(this.getAttribute('href')).ScrollTo({
              axis: 'y',
              offsetTop: gutterWidth
            });
          }).affix({
            offset: {
