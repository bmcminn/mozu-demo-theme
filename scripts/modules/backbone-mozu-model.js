define([
...
], function ($, _, api, Backbone, MessageModels) {
    ...
    /** @lends MozuModel.prototype */
    {
      ...
      get: function (attr) {
        ...
        if (!ret && this.relations && (attr in this.relations)) {
          ret = this.setRelation(attr, null, {
            silent: true
          });
  ...
  var MozuModel = Backbone.MozuModel = Backbone.Model.extend(modelProto, {
    ...
    fromCurrent: function () {
      return new this(require.mozuData(this.prototype.mozuType), {
        silent: true,
        parse: true
      });
    },
   ...
   * [extend description]
   * @param  {[type]} conf    [description]
   * @param  {[type]} statics [description]
   * @return {[type]}         [description]
   */
