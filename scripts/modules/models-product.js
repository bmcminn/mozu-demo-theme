define([
  ...
  function ($, _, Backbone, Hypr, PriceModels, api) {
    ...
    var ProductOption = Backbone.MozuModel.extend({
        ...
        initialize: function () {
          ...
          /**
           * [equalsThisValue description]
           * @param  {[type]} fvalue [description]
          ...
          var equalsThisValue = function (fvalue, newVal) {
            ...
            /**
             * [containsThisValue description]
             * @param  {[type]} existingOptionValueListing [description]
             * @param  {[type]} newVal                     [description]
             * @return {[type]}                            [description]
             */
          ...
          if (attributeDetail) {
            if (attributeDetail.valueType === ProductOption.Constants.ValueTypes.Predefined) {
              this.legalValues = _.chain(this.get('values')).pluck('value').map(function (v) {
                return !_.isUndefined(v) && !_.isNull(v) ? v.toString() : v;
              }).value();
            }
         ...
         * @param  {[type]} newValObj [description]
        ...
        parse: function (raw) {
          ...
          if (raw.isMultiValue) {
            vals = _.pluck(_.where(raw.values, {
              isSelected: true
            }), 'value');
            if (vals && vals.length > 0) raw.value = vals;
          }
          else {
            selectedValue = _.findWhere(raw.values, {
              isSelected: true
            });
        ...
        isValidValue: function () {
          ...
          return value !== undefined && value !== '' && (this.get('attributeDetail').valueType !== ProductOption.Constants.ValueTypes.Predefined || (this.get('isMultiValue') ? !_.difference(_.map(value, function (v) {
            return v.toString();
          }), this.legalValues).length : _.contains(this.legalValues, value.toString())));
        },


        /**
         * [getValueOrShopperEnteredValue description]
         * @return {[type]} [description]
         */
         ...
         * @param {[type]} biscuit [description]
         * @param {[type]} options [description]
         */
      ...
      Product = Backbone.MozuModel.extend({
        ...
        /**
         * [getBundledProductProperties description]
        ...
        /**
         * [calculateHasPriceRange description]
        ...
        initialize: function (conf) {
          ...
          this.set({
            url: slug ? "/" + slug + "/p/" + this.get("productCode") : "/p/" + this.get("productCode")
          });
